...
- `SUPABASE_SERVICE_ROLE_KEY`: **Pflicht** für die Server-Routen. Ohne diesen Schlüssel schlagen Inserts wegen RLS-Policies mit Fehler `42501 new row violates row-level security policy` fehl.
